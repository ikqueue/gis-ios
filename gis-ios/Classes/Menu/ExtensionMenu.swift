...
extension CreateAreaController {
    ...
    func setUpBarButtonMenu() -> Void {
        ...
        if let image = UIImage(named: "menu"), let selector = #selector(CreateAreaController.touchMenu) as Selector?{
            addLeftBarButtonWithImage(image, selector: selector)
    ...
    func setUpBarButtonMyLocation() -> Void {
        ...
        if let image = UIImage(named: "bookmark"), let selector = #selector(CreateAreaController.touchMyLocation) as Selector?{
            addRightBarButtonWithImage(image, selector: selector, badge: 0)
    ...
    @objc func touchMenu() -> Void {
        ...
        UIView.animate(withDuration: 0.1, delay: 0.0, options: .curveEaseInOut, animations: { () -> Void in
            ...
            var blurFrame: CGRect = self.menuBlur.frame
            blurFrame.origin.y = self.menuView.frame.height //self.menuView.frame.height
            self.menuBlur.frame = blurFrame
            
            self.menuView.isHidden = false
            self.addLeftBarButtonWithImage(UIImage(named: "close")!, selector: #selector(CreateAreaController.dismissMenu) as Selector?)
            self.addRightBarButtonWithImage(UIImage(), selector: nil, badge: 0)
            self.setUpNavigationBar(barTint: UIColor.white, tint: UIColor.titleText(), titleTextAt: UIColor.titleText(), showTitle: true, title: "GIS ONLINE")
            self.menuBlur.isHidden = false
        }, completion: {_ in
...
extension CreateAreaController: UICollectionViewDelegateFlowLayout {
...
extension CreateAreaController: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return menuTitle.count
    }
...
extension CreateAreaController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        switch indexPath.row {
        case 0:
...
extension KnowledgeController {
    ...
    func setUpBarButtonMenu() -> Void {
        ...
        if let image = UIImage(named: "menu"), let selector = #selector(KnowledgeController.touchMenu) as Selector?{
            addLeftBarButtonWithImage(image, selector: selector)
...
//    func setUpBarButtonMyLocation() -> Void {
//
//        if let image = UIImage(named: "bookmark"), let selector = #selector(KnowledgeController.touchMyLocation) as Selector?{
//            addRightBarButtonWithImage(image, selector: selector, badge: 0)
//
//        }
//    }
    ...
    @objc func touchMenu() -> Void {
        ...
        UIView.animate(withDuration: 0.1, delay: 0.0, options: .curveEaseInOut, animations: { () -> Void in
            ...
            var blurFrame: CGRect = self.blurView.frame
            blurFrame.origin.y = self.menuView.frame.height-UIApplication.shared.statusBarFrame.height //self.menuView.frame.height
            self.blurView.frame = blurFrame
            
            self.menuView.isHidden = false
            self.addLeftBarButtonWithImage(UIImage(named: "close")!, selector: #selector(KnowledgeController.dismissMenu) as Selector?)
            self.addRightBarButtonWithImage(UIImage(), selector: nil, badge: 0)
            self.setUpNavigationBar(barTint: UIColor.white, tint: UIColor.titleText(), titleTextAt: UIColor.titleText(), showTitle: true, title: "GIS ONLINE")
            self.blurView.isHidden = false
        }, completion: {_ in
...
extension KnowledgeController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: menuCollectionview.frame.size.width/3-10, height: 120)
    }
...
extension KnowledgeController: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return menuTitle.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let menuCell = menuCollectionview.dequeueReusableCell(withReuseIdentifier: "MenuCell", for: indexPath) as! MenuCell
        menuCell.logo.image = menuIogo[indexPath.row]
        menuCell.textTItle.text = menuTitle[indexPath.row]
        return menuCell
    }
...
extension KnowledgeController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        switch indexPath.row {
        case 0:
...
extension DownloadController {
    ...
    func setUpBarButtonMenu() -> Void {
        ...
        if let image = UIImage(named: "menu"), let selector = #selector(DownloadController.touchMenu) as Selector?{
            addLeftBarButtonWithImage(image, selector: selector)
    ...
    @objc func touchMenu() -> Void {
        ...
        UIView.animate(withDuration: 0.1, delay: 0.0, options: .curveEaseInOut, animations: { () -> Void in
            ...
            self.menuView.isHidden = false
            self.addLeftBarButtonWithImage(UIImage(named: "close")!, selector: #selector(DownloadController.dismissMenu) as Selector?)
            self.addRightBarButtonWithImage(UIImage(), selector: nil, badge: 0)
            self.setUpNavigationBar(barTint: UIColor.white, tint: UIColor.titleText(), titleTextAt: UIColor.titleText(), showTitle: true, title: "GIS ONLINE")
            self.menuBlur.isHidden = false
        }, completion: {_ in
...
extension DownloadController: UICollectionViewDelegateFlowLayout {
...
extension DownloadController: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return menuTitle.count
    }
...
extension DownloadController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        switch indexPath.row {
        case 0:
